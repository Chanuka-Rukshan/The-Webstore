...
@WebServlet(name = "PasswordVerify", urlPatterns = {"/PasswordVerify"})
public class PasswordVerify extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (ses.getAttribute("email") == null) {
            ...
            String newPassword = ses.getAttribute("conformPassword").toString();

            JsonObject verification = gson.fromJson(request.getReader(), JsonObject.class);
            String verificationCode = verification.get("fullOtp").getAsString();
            ...
            if (verificationCode.isEmpty()) {
                ...
                Criterion crt2 = Restrictions.eq("otp", verificationCode);
                ...
                if (c1.list().isEmpty()) {
                    ...
                    responseObject.addProperty("message", "Change Password successfull");
